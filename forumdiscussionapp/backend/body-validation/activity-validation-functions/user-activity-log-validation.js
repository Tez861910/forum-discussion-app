...
export const validateUserActivityLogCreate = validate(
  Joi.object({
...
export const validateUserActivityLogUpdate = validate(
  Joi.object({
...
export const validateUserActivityLogDelete = validate(
  Joi.object({
