...
import { handleReactionTypeCreate } from '../../route-files/accessories-function-routes/reaction-type-routes/handle-reactionType-create.js';
import { handleReactionTypeUpdate } from '../../route-files/accessories-function-routes/reaction-type-routes/handle-reactionType-update.js';
import { handleReactionTypeDelete } from '../../route-files/accessories-function-routes/reaction-type-routes/handle-reactionType-delete.js';
import { handleReactionTypeGetAll } from '../../route-files/accessories-function-routes/reaction-type-routes/handle-reactionType-get-all.js';
