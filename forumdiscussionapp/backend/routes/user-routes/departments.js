...
router.post('/create', verifyJwt, validateDepartmentCreate, handleDepartmentCreate);

// Update department
router.put('/update/:departmentId', verifyJwt, validateDepartmentUpdate, handleDepartmentUpdate);

// Delete department
router.delete('/delete/:departmentId', verifyJwt, validateDepartmentDelete, handleDepartmentDelete);
