...
router.post('/create', verifyJwt, validateReadReceiptGroupCreate, handleReadReceiptGroupCreate);

// Get read receipt for group message by ID
router.get('/get/:receiptId', verifyJwt, validateReadReceiptGroupGet, handleReadReceiptGroupGet);
